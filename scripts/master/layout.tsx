            ...
            {!!props.username && <div className='mbb-menu'>
                <Menu size='massive' inverted secondary vertical fluid>
                    ...
                    <Menu.Item>
                        ...
                        <Menu.Menu>
                            <Menu.Item link onClick={() => location.href = 'http://localhost:3002/bin/dev/item1'}><span className='mbb-menu-item1'><Icon name='weibo'/>Item 1</span><span className='mbb-menu-item2'><Popup trigger={<Icon name='weibo'/>} content='Item1' position='right center' inverted/></span></Menu.Item>
                            <Menu.Item link onClick={() => location.href = 'http://localhost:3002/bin/dev/item2'}><span className='mbb-menu-item1'><Icon name='whatsapp'/>Item 2</span><span className='mbb-menu-item2'><Popup trigger={<Icon name='whatsapp'/>} content='Item2' position='right center' inverted/></span></Menu.Item>
                        </Menu.Menu>
                    </Menu.Item>
                    <Menu.Item>
